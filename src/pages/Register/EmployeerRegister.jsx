            ...
            <div className="hero min-h-screen bg-base-300 pb-6">
                <div className="hero-content flex-col">
                    <div className="text-center mt-6 mb-6">
                        <h1 className="text-4xl font-bold">Employeer Registration!</h1>
                    </div>
                    <div className="card shrink-0 w-full shadow-2xl bg-base-100">
                        <form className="card-body">
                            ...
                            <div className="form-control">
                                <label className="label">
                                    <span className="label-text">Compnay Name</span>
                                </label>
                                <input type="text" name="company-name" className="input input-bordered" required />
                            </div>
                            <div className="form-control">
                                <label className="label">
                        ...
                        <div className="text-center px-4">
                            <p className="text-base">Are you an Employee? Please<Link to='/sign-up'><button className="btn btn-link font-bold">Register Here!</button></Link></p>
                        </div>
